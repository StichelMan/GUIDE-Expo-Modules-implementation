...
5) Create a new file in the same directory as 'MainActivity', named 'MainApplication.kt', and paste the required code which I will upload an example of as a file within this chat
